<form action="<?php e(url()); ?>" method="POST">
    <fieldset>
        ...
        <input type="submit" name="opdater_rater" value="Opdater" /> <a href="<?php e(url(null, array('addrate' => 1))); ?>">Tilføj rate</a> <a href="<?php e(url(null, array('addrate' => -1))); ?>">Fjern rate</a>
    </fieldset>
    </form>