<table id="prisoversigt">
    ...
    <tr>
        <th>Antal uger</th>
        <td><?php e($tilmelding->get("ugeantal")); ?></td>
    </tr>

    <tr>
        <th>Ugepris</th>
        <td><?php e(number_format($tilmelding->get("pris_uge"), 0, ',','.')); ?></td>
    </tr>

    <tr>
        <th>Samlet ugepris</th>
        <td><?php e(number_format($tilmelding->get("ugeantal") * $tilmelding->get("pris_uge"), 0, ',', '.')); ?></td>
    </tr>
    <tr>
  ...
  <?php if ($tilmelding->get("aktiveret_tillaeg") > 0): ?>
    <tr>
        ...
        <td><?php e(number_format($tilmelding->get("aktiveret_tillaeg"), 0, "", "")); ?></td>
    </tr>
  <?php endif; ?>
    ...
    <?php if($tilmelding->get("pris_afbrudt_ophold") != 0): ?>
        <tr>
            ...
            <td><?php e(number_format($tilmelding->get("pris_afbrudt_ophold"), 0, ',', '.')); ?></td>
        </tr>
        <?php endif; ?>

  <?php if ($tilmelding->get("elevstotte") > 0): ?>
    <tr>
        <th>Elevstøtte (<?php e($tilmelding->get('elevstotte')); ?> kr * <?php e($tilmelding->get('ugeantal_elevstotte')); ?> uger)</th>
        <td> - <?php e(number_format($tilmelding->get("elevstotte") * $tilmelding->get('ugeantal_elevstotte'), 0, "", "")); ?></td>
    </tr>
  <?php endif; ?>
  <?php if ($tilmelding->get("kompetencestotte") > 0): ?>
    <tr>
        <th>Kompetencestøtte (<?php e($tilmelding->get('kompetencestotte')); ?> kr * <?php e($tilmelding->get('ugeantal')); ?> uger)</th>
        <td> - <?php e(number_format($tilmelding->get("kompetencestotte"), 0, "", "") * $tilmelding->get('ugeantal')); ?></td>
    </tr>
  <?php endif; ?>
  <?php if ($tilmelding->get("statsstotte") > 0): ?>
    <tr>
        <th>Indvandrerstøtte (<?php e($tilmelding->get("statsstotte")); ?> * <?php e($tilmelding->get('ugeantal')); ?>)</th>
        <td>- <?php e(number_format($tilmelding->get("statsstotte") * $tilmelding->get('ugeantal'), 0, "", "")); ?></td>
    </tr>
  <?php endif; ?>
 <?php if ($tilmelding->get("kommunestotte") > 0): ?>
    <tr>
        <th>Kommunestøtte</th>
        <td> - <?php e(number_format($tilmelding->get("kommunestotte"), 0, "", "")); ?></td>
    </tr>
  <?php endif; ?>

    <tr>
        <th>Samlet pris</th>
        <td><?php e(number_format($tilmelding->get("pris_total"), 0, ',','.')); ?></td>
    </tr>

    <tr>
        <th>Har betalt</th>
        <td>
            <?php e(number_format((int)$tilmelding->get("betalt"), 0, ',', '.')); ?>
    ...
    if($tilmelding->get("forfalden") > 0) {
        ...
        <tr>
            <th>Forfalden</th>
            <td class="red" style="text-align: right;"><?php e(number_format($tilmelding->get("forfalden"), 0, ',','.')); ?></td>
        </tr>
        <?php
    }
    ?>
